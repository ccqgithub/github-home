...
BMapCoordSys.prototype.setViewPort = function (viewportPoints) {
...
BMapCoordSys.create = function (ecModel, api) {
    ...
    ecModel.eachComponent('bmap', function (bmapModel) {
        ...
        var viewportPoints = bmapModel.get('viewportPoints');

        if (Array.isArray(viewportPoints) && viewportPoints.length >= 2) {
            var points = viewportPoints.map(function(item) {
...
echarts.extendComponentModel({
    ...
    setViewPort: function(viewportPoints) {
        this.option.viewportPoints = viewportPoints;
    },
